<%-- 
    Document   : tamperedFiles
    Created on : Jan 30, 2016, 7:52:55 PM
    Author     : Ankush
--%>
...
<html>
    <head>
        <title>YouCloud | Tampered Files</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            <%session.setAttribute("pageName", "tamperedFiles");%>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Tampered Files</li>
                    </ol>
                </section>
                    ...
                    <form action="#" method="post">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><%=timestamp%></td>
                                <td><a href="#">View</a>&nbsp;&nbsp;&nbsp;
                                    <a href="fileBlocksDownload.jsp?downfileid=<%=fileid%>">Download</a>
                                    &nbsp;&nbsp;&nbsp;
